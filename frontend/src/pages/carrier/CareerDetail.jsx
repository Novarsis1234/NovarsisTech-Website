  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`https://novarsistech.com/careers/${job?._id || job?.id || id}`}
        />
        ...
        <meta
          property="og:url"
          content={`https://novarsistech.com/careers/${job?._id || job?.id || id}`}
        />
        <meta
          property="og:image"
        ...
        {/* ✅🔥 JOB POSTING SCHEMA (VERY POWERFUL SEO BOOST) */}
        {job?.title && (
