...
>
  ...
  <h2 className="sr-only">
    Novarsis Technology Software Solutions and Digital Business Scaling Services
  </h2>
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 py-28">
    ...
    <div className="max-w-3xl mb-20">
      ...
      <p className="text-gray-300 text-base sm:text-lg leading-relaxed text-justify">
        ...
        businesses build scalable applications, powerful digital platforms,
        and performance-focused online solutions using modern technologies.
      </p>
    </div>
      ...
      {services.map((service, index) => (
        ...
        >
          ...
          <p className="text-gray-300 text-sm leading-relaxed mb-6">
            Custom {service.name.toLowerCase()} services crafted to deliver
            performance, scalability, security, and long-term business
            growth.
          </p>
