  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h2 className="text-4xl md:text-5xl font-extrabold text-[#008300] mb-4">
          Our Expert Team
        </h2>
...
>
  ...
  <img
    ...
    alt={member.name}
    className="w-full h-full object-top object-contain transform transition-transform duration-500 hover:scale-110"
  />
</div>
  ...
  <div className="p-6 text-center">
    <h3 className="text-xl md:text-2xl font-semibold text-[#008300] mb-1">
      {member.name}
    </h3>
