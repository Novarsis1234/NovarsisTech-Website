  ...
  return (
    <>
      <Helmet>
        ...
        {/* ✅🔥 TEAM PAGE SCHEMA (E-E-A-T BOOST) */}
        <script type="application/ld+json">
          {`
      {
        "@context":"https://schema.org",
        "@type":"WebPage",
        "name":"Our Expert Team - Novarsis Technology",
        ...
        "description":"Meet the expert team of Novarsis Technology specializing in software development, UI/UX design, and digital innovation."
      }
    `}
        </script>
      </Helmet>
      ...
      <section className="relative py-24 bg-white overflow-hidden">
        ...
        <h2 className="sr-only">
          Novarsis Technology Expert Team – Professional IT Developers and
          Specialists
        </h2>
