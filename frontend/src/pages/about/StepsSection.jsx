      ...
      <div className="max-w-6xl mx-auto text-center px-4">
        ...
        <Reveal>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
            How to <span className="text-[#008300]">Scale your Business</span>
          </h2>
        </Reveal>
        <Reveal>
        ...
        {steps.map((step, index) => (
          ...
          >
            ...
            <div className="md:w-1/2 w-full flex justify-center z-10">
              <Reveal>
                <img
                  src={step.image}
                  alt={step.title}
                  className="rounded-xl shadow-lg w-[85%] object-cover border-l-4 border-r-4 border-[#008300] transition-transform duration-500 hover:scale-105"
                />
              </Reveal>
            </div>
            ...
            <div
              ...
              border-l-4 border-r-4 border-[#008300] transition-transform duration-500 hover:scale-105
              ${index % 2 === 0 ? "md:ml-[-100px]" : "md:mr-[-100px]"}`}
            >
              <Reveal>
                <p className="text-[#008300] font-semibold text-sm mb-1">
                  {step.step}
                </p>
              </Reveal>
              <Reveal>
