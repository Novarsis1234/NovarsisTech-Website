    ...
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-28">
          ...
          <div className="bg-white rounded-3xl p-8 sm:p-10 shadow-xl space-y-6">
            ...
            <p className="text-gray-700 leading-relaxed text-justify">
              Novarsis SEO Tool is a smart automation platform that continuously
              analyzes your WordPress website, detects SEO issues, and applies
              intelligent fixes automatically — eliminating repetitive manual
              SEO work.
            </p>
            ...
            <div className="bg-[#f3fff6] border border-[#008300]/30 p-5 rounded-2xl">
              <p className="text-gray-700">
                <strong>Outcome:</strong> Faster rankings, improved visibility,
                reduced errors, and consistent SEO growth — without complexity.
              </p>
            </div>

            <p className="text-gray-700 text-justify">
              <strong>Best For:</strong> Bloggers, agencies, startups, digital
              marketers, and businesses managing multiple WordPress websites.
            </p>
          </div>
        ...
        <Reveal>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-28">
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-10 shadow-xl space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed text-justify">
                A centralized digital ecosystem designed to manage academic,
                administrative and communication needs of schools. It improves
                efficiency, transparency and real-time collaboration between
                teachers, students, parents and management.
              </p>
              ...
              <div className="bg-[#f3fff6] border border-[#008300]/30 p-5 rounded-2xl">
                <p className="text-gray-700">
                  <strong>Result:</strong> A fully digitized school ecosystem
                  with smooth workflows, transparent operations and smarter
                  decision-making.
                </p>
              </div>
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto">
        ...
        <div className="text-center mb-16 flex flex-col items-center gap-5">
          ...
          <p className="max-w-3xl mx-auto text-gray-700 text-lg">
            Complete digital solution for hotels, restaurants & banquet halls
          </p>
        </div>
        ...
        <Reveal>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-28">
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-10 shadow-xl space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed text-justify">
                A powerful centralized hotel management system designed to automate
                room bookings, restaurant operations, banquet events, enquiries and payments.
              </p>
              ...
              <div className="bg-[#f3fff6] border border-[#008300]/30 p-5 rounded-2xl">
                <p className="text-gray-700">
                  <strong>Result:</strong> Faster bookings, better guest experience and higher revenue.
                </p>
              </div>
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto">
        ...
        <div className="text-center mb-16 flex flex-col items-center gap-5">
          ...
          <p className="max-w-3xl mx-auto text-gray-700 text-lg text-justify">
            Complete digital solution for tours, travel & vehicle management
          </p>
        </div>
        ...
        <Reveal>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-28">
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-10 shadow-xl space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed text-justify">
                A modern tour & travel management system that enables agencies
                to manage tour packages, itineraries, vehicles, hotels,
                bookings and customer enquiries from one centralized platform.
              </p>
