  ...
  return (
    <section className="w-full bg-gray-50 py-16 px-6">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl p-10 border border-gray-100">
        <h1 className="text-3xl sm:text-4xl font-bold text-center text-[#008300] mb-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <input
              ...
              className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#008300] transition"
            />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-[#008300] to-[#008300] text-white font-semibold py-3 rounded-md shadow-lg hover:opacity-90 transition"
          >
