        ...
        <div className="relative z-10 text-center text-white px-6">
          ...
          <Reveal>
            <p className="mt-6 max-w-3xl mx-auto text-gray-200 text-lg">
              User-centered, visually stunning and conversion-focused
...
<section className="relative py-16 px-6 bg-[#fffaf2] overflow-hidden">
  ...
  <div className="max-w-7xl mx-auto relative z-10">
    ...
    <Reveal>
      <p className="text-gray-700 text-lg leading-relaxed text-justify mb-12">
        ...
        We follow a user-centric design approach that includes research,
  ...
  <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center relative z-10">
    ...
    <div>
      ...
      {[
        { q: "Do you provide wireframes & prototypes?", a: "Yes, complete wireframes and interactive prototypes." },
        { q: "Will designs be developer-friendly?", a: "Yes, we follow proper design handoff standards." },
        { q: "Do you redesign existing products?", a: "Yes, UI/UX audits and redesign services available." },
      ].map((item, i) => (
