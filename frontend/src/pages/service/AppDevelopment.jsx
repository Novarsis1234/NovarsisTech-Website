    ...
    <Reveal>
      ...
      <section className="py-20 px-6 bg-[#008300] text-white">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-10 text-center">
          ...
          <Stat icon={<FaProjectDiagram />} value="60+" label="Apps Delivered" />
  ...
  <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center relative z-10">
    ...
    <Reveal>
      <div className="relative max-w-md mx-auto md:max-w-none">
        <div className="absolute inset-0 bg-[#008300]/10 
    ...
    <div>
      ...
      {[
        { q: "How long does app development take?", a: "15–45 days depending on features." },
        { q: "Do you publish apps on Play Store & App Store?", a: "Yes, complete deployment support." },
        { q: "Do you provide maintenance?", a: "Yes, long-term support & updates." },
      ].map((item, i) => (
