  ...
  return (
    <section className="py-20 bg-gray-50 font-sans">
      ...
      <div className="text-center mb-12">
        <Reveal>
          <p className="text-[#008300] font-semibold uppercase tracking-wider">
            What’s Happening
          </p>
        </Reveal>
        <Reveal>
          <h2 className="text-3xl md:text-4xl font-bold text-[#0B1B3F] mt-2">
            ...
            <span className="text-[#008300]">Posts</span>
          </h2>
        </Reveal>
        <Reveal>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 px-6">
        {posts.map((post) => (
          ...
          >
            ...
            <div className="absolute left-0 top-0 w-1 h-full bg-gradient-to-b from-[#008300] to-[#0B1B3F] scale-y-0 group-hover:scale-y-100 origin-top transition-transform duration-500"></div>
            ...
            <div className="relative overflow-hidden">
              ...
              <Reveal>
                <span className="absolute top-3 left-3 bg-[#008300] text-white text-xs font-medium px-3 py-1 rounded-full shadow-md">
                  {post.category}
                </span>
              </Reveal>
            </div>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between text-sm text-gray-500 mb-3">
                <Reveal>
                  <div className="flex items-center gap-2">
                    <FaUser className="text-[#008300]" /> {post.author}
                  </div>
                </Reveal>
                <Reveal>
                  <div className="flex items-center gap-2">
                    <FaCalendarAlt className="text-[#008300]" /> {post.date}
                  </div>
                </Reveal>
              </div>

              <Reveal>
                <h3 className="text-lg font-bold text-[#0B1B3F] hover:text-[#008300] transition-colors duration-300">
                  {post.title}
                </h3>
              </Reveal>
              ...
              <Reveal>
                <a
                  href={post.link}
                  className="inline-block mt-4 text-[#008300] font-medium hover:underline"
                >
                  Read More →
                </a>
              </Reveal>
