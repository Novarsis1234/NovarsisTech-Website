...
const SecuritySection = () => {
  ...
  return (
    <section className="relative bg-[#f9fbff] py-20 px-6 md:px-16 overflow-hidden">
      ...
      <div className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-[#008300] to-[#008300] origin-top scale-y-100"></div>
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center gap-12">
        ...
        <div className="relative">
          ...
          <div className="absolute -left-6 top-0 bottom-0 w-1 bg-gradient-to-b from-[#008300] to-[#008300] rounded-full hidden md:block"></div>

          <Reveal>
            <p className="text-[#008300] font-semibold mb-2 uppercase tracking-wide">
              Advance Protect
            </p>
          </Reveal>

          <Reveal>
            <h2 className="text-3xl md:text-4xl font-bold text-[#008300] mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {services.map((service, index) => (
              <div
                key={index}
                className="flex items-center bg-white border-l-4 border-[#008300] shadow-md rounded-md px-4 py-3 hover:bg-[#008300]/10 hover:scale-105 hover:shadow-xl hover:border-[#008300] transition-all duration-500 cursor-pointer"
              >
                <Reveal>
                  <div className="bg-[#008300] text-white p-2 rounded-md text-lg mr-3 transition-transform duration-500 group-hover:rotate-12">
                    {service.icon}
                  </div>
                </Reveal>
                <Reveal>
                  <span className="font-semibold text-[#008300] text-sm md:text-base">
                    {service.label}
                  </span>
                </Reveal>
              </div>
