...
const Section = () => {
  return (
    ...
    >
      {/* Blue overlay */}
      <div className="absolute inset-0 bg-green-200/80"></div>

      {/* Content */}
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-12 max-w-7xl mx-auto">
        {/* Left Side */}
        <div className="md:w-1/2 space-y-6">
        <Reveal> <p className="text-[#008300] font-medium text-lg">
            Do You Need a Meeting?
          </p></Reveal> 

        <Reveal>  <h1 className="text-4xl md:text-5xl font-bold leading-tight text-black">
            Better IT Solutions <br /> And Services At <br /> Your Fingertips
          </h1></Reveal>

          <div className="w-20 h-1 bg-[#008300] rounded-full mt-2"></div>

        <Reveal>  <p className="text-black text-lg leading-relaxed">
            We help our clients succeed by creating brand identities, digital
            experiences, and print materials that communicate clearly.
          </p></Reveal>

          <div className="flex items-center gap-5 mt-6">
          <Reveal>  <Link to={"/services"} className="bg-[#008300] hover:bg-[#0277BD] text-white font-semibold py-3 px-8 rounded-md transition-all duration-300">
              Learn More
            </Link></Reveal>
             </div>
        </div>
