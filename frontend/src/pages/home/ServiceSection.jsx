        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {services.map((service) => (
            ...
            >
              ...
              <div className="relative mx-auto mb-6 w-24 h-24 rounded-full bg-gray-100 flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="absolute w-full h-full rounded-full transition-all duration-500 group-hover:animate-[spin_5s_linear_infinite]">
                    <span className="absolute top-2 left-2 w-3 h-3 bg-[#008300] rounded-full"></span>
                    <span className="absolute bottom-2 right-2 w-3 h-3 bg-[#008300] rounded-full"></span>
                  </div>
                </div>
              </div>

              <Reveal>
                <h3 className="text-lg font-bold text-[#008300] mb-2 relative z-10">
                  {service.title}
                </h3>
              </Reveal>
              <Reveal>
              ...
              <Link
                to={"/services"}
                className="text-[#008300] font-semibold hover:underline relative z-10"
              >
                Learn More
              </Link>
            </div>
