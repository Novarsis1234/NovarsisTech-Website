  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`https://novarsistech.com/services`}
        />
        ...
        <meta
          property="og:url"
          content="https://novarsistech.com/services"
        />
        <meta
          property="og:image"
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Professional IT Services including web development, app development, SEO optimization, digital marketing, UI/UX design, and graphic design.",
            "sameAs": [
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Comprehensive collection of professional IT services including web development, app development, UI/UX design, SEO, and digital marketing.",
            "provider": {
              "@type": "Organization",
              "name": "Novarsis Technology",
              "url": "https://novarsistech.com"
        ...
        hover:bg-[#009e3c] transition disabled:opacity-40 z-20"
            ...
            transform hover:-translate-y-2 hover:scale-105 overflow-hidden"
                ...
                group-hover:bg-white group-hover:text-[#008300] transition"
                  ...
                  {/* CONTENT */}
                  <div className="p-6">
                    <h2 itemProp="name" className="text-lg font-bold text-[#008300] mb-3">
                      {service.title}
                    </h2>

                    <p itemProp="description" className="text-gray-600 text-sm leading-relaxed text-justify">
                      {service.desc}
                    </p>
