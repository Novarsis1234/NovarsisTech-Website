      ...
      <div className="max-w-7xl mx-auto px-6 grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        {services.map((service, i) => (
          ...
          >
            ...
            <div className="absolute inset-0 rounded-2xl border-[3px] border-transparent bg-gradient-to-r from-[#008300] via-[#00C6FF] to-[#0066FF] opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-gradient-border pointer-events-none"></div>
            ...
            <div className="relative overflow-hidden">
              ...
              <Reveal>
                <div className="absolute -bottom-5 right-4 bg-[#008300] group-hover:bg-white text-white group-hover:text-[#008300] p-3 rounded-lg transition-all duration-500 z-10 shadow-md">
                  {service.icon}
                </div>
              </Reveal>
            </div>
