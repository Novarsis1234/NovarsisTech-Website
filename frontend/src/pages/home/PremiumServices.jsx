...
const PremiumServices = () => {
  return (
    <section className="relative bg-green-200 py-20 overflow-hidden">
    ...
    <Reveal>      <p className="text-[#008300] font-semibold uppercase tracking-wider">
            What We’re Offering
          </p></Reveal>
         <Reveal>   <h2 className="text-4xl font-bold text-black leading-snug mt-2">
            Also dealing in these IT <br /> Premium Services
          </h2></Reveal>
          <div className="h-1 w-24 bg-[#008300] rounded-full mt-4 mx-auto md:mx-0"></div>
        </div>

    <Reveal>     <p className="text-black md:w-1/2 mt-6 md:mt-0 text-sm sm:text-base leading-relaxed">
    ...
    <Reveal>  <div className="max-w-7xl mx-auto px-6 grid gap-8 sm:grid-cols-2 lg:grid-cols-5 relative z-10">
        {premiumServices.map((service, i) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-[#008300] transform scale-y-0 origin-bottom group-hover:scale-y-100 transition-transform duration-500 z-0"></div>

            <div className="relative z-10">
              <div className="bg-[#e8f6ff] text-[#008300] text-4xl inline-flex p-4 rounded-full mb-4 group-hover:bg-white group-hover:text-[#0b1b3f] transition duration-500">
                {service.icon}
              </div>
