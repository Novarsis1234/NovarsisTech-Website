  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          property="og:title"
          content="Premium IT & Creative Services - Novarsis Technology"
        />
        <meta
        ...
        <div className="max-w-7xl mx-auto px-6 mb-20 relative z-10">
          ...
          <Reveal>
            <p className="max-w-2xl mt-6 text-gray-200 text-sm md:text-base leading-relaxed">
              We deliver future-ready IT and creative solutions combining
              innovation, performance, and scalability to help brands grow with
              confidence.
            </p>
          </Reveal>
        </div>
