...
const TestimonialsSection = () => {
  ...
  return (
    <section className="relative py-24 px-6 overflow-hidden bg-green-200 text-black">
      {/* Decorative Blurs */}
      ...
      <div className="relative text-center mb-16">
        ...
        <Reveal>
          <h2 className="text-4xl md:text-5xl font-bold mt-3">
            What Our <span className="text-[#008300]">Clients Say</span>
          </h2>
        </Reveal>
        <Reveal>
      ...
      <div className="relative max-w-7xl mx-auto overflow-x-auto scrollbar-hide">
        <div className="flex space-x-6 md:space-x-8 pb-4">
          {testimonials.map((t, index) => (
            <div
              key={index}
              className="flex-none w-80 bg-black/10 backdrop-blur-lg rounded-2xl p-6 text-black border border-black/20 shadow-xl transition-transform duration-500 hover:-translate-y-2 hover:shadow-[0_0_20px_rgba(0,163,255,0.4)]"
            >
              {/* Avatar */}
              <div className="flex justify-center mb-5">
                <Reveal>
                  <img
                    src={t.image}
                    alt={t.name}
                    className="w-20 h-20 rounded-full border-4 border-[#008300]/70 shadow-lg bg-[#004aad]/30 p-1"
                  />
                </Reveal>
              </div>
              ...
              {/* Review Text */}
              <Reveal>
                <p className="text-black text-center italic leading-relaxed mb-4">
                  “{t.review}”
                </p>
              </Reveal>
                ...
                {[...Array(5)].map((_, i) => (
                  <FaStar
                    ...
                    className={`text-xl transition ${
                      i < t.rating ? "text-[#FFD700]" : "text-black/30"
                    }`}
                  />
                ))}
              </div>
      ...
      {/* Scroll hint */}
      <Reveal>
        <p className="text-center text-black/60 mt-8 text-sm">
