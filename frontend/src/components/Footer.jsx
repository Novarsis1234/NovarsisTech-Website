  ...
  return (
    <footer className="bg-[#0b1424] text-white pt-16 pb-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-4 gap-10">
        {/* ========== QUICK LINKS ========== */}
        <div>
          <h3 className="text-xl font-semibold mb-6 border-l-4 border-[#008300] pl-3">
            Quick Links
          </h3>
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              ["Portfolio", "Our recent projects", "/portfolio"],
          ...
          <ul className="space-y-3 text-gray-300 text-sm">
            <Reveal>
              <li className="flex items-start">
                <FaMapMarkerAlt className="text-[#008300] mt-1 mr-3" />
                <a
                  href="https://maps.app.goo.gl/1VWNa3CsZPsuK6YEA"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-[#008300] transition"
                >
                  301, 3rd floor, Vikram Urban, Vijay Nagar, Indore, Madhya Pradesh 452010
                </a>
              </li>
            </Reveal>
            <Reveal>
              <li className="flex items-center">
                <FaPhoneAlt className="text-[#008300] mr-3" />
                <a
            ...
            <Reveal>
              <li className="flex items-center">
                <FaEnvelope className="text-[#008300] mr-3" />
                <a
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 border-t border-gray-800 pt-10 grid md:grid-cols-3 gap-10">
        ...
        <div>
          <ul className="text-sm text-gray-300 space-y-2">
            <Reveal>
              <li className="flex items-center">
                <FaMapMarkerAlt className="text-[#008300] mr-3" />
                <a
                  href="https://maps.app.goo.gl/1VWNa3CsZPsuK6YEA"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <Reveal>
              <li className="flex items-center">
                ...
                <a
                  href="tel:+916264059829"
                  className="hover:text-[#008300] transition ml-1"
                >
                  +91 6264059829
                </a>
              </li>
      ...
      <div className="flex gap-3 flex-wrap">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="p-2 rounded-md bg-[#111b2e] hover:bg-[#008300] transition"
        >
          <FaFacebookF size={16} />
        </a>
        <a
      ...
      <div className="border-t border-gray-800 mt-10 pt-5 text-center text-sm text-gray-400">
        <Reveal>
          <p>
            Copyright © 2025{" "}
            <span className="text-[#008300]">Novarsis Technology</span> | All
            rights reserved.
          </p>
        </Reveal>
        <div className="mt-3 flex justify-center flex-wrap gap-3 text-xs">
          {[
            ...
            <Link
              key={i}
              to={path}
              className="text-[#008300] hover:underline transition"
            >
              {label}
            </Link>
          ))}
      ...
      <div className="fixed right-6 bottom-20 flex flex-col gap-4">
       <a
  href="tel:+919111720303"
  className="bg-white text-[#008300] p-3 rounded-full shadow-lg hover:scale-110 transition"
>
  <FaPhoneAlt />
</a>
<a
