      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <Reveal>
          <input
            ...
            className="w-full p-3 rounded-md text-white bg-white placeholder-gray-400 focus:outline-none"
          />
          {errors.name && (
        ...
        <Reveal>
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#008300] hover:bg-[#008AD6] text-white font-semibold py-3 rounded-md transition"
          >
